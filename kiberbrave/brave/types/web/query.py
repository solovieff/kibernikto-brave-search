...
class Query(BaseModel):
    ...
    is_navigational: Optional[bool] = Field(description="Whether the query is a navigational query to a domain.",
                                            default=False)
    is_news_breaking: Optional[bool] = Field(description="Whether the query has location relevance.")
